...
namespace ChipChop.Areas.Admin.Controllers
{
    ...
    public class GroupsController : Controller
    {
        ...
        public async Task<IActionResult> Create(Group @group)
        {
            ...
            {
                group.Img = await new ImageClass().createSVG(group.Img, group.GroupName);
                _context.Add(@group);
        ...
        public async Task<IActionResult> Edit(int id, Group @group, string oldFile)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    group.Img = await new ImageClass().editSVG(group.Img, group.GroupName, oldFile);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (@group != null)
            {
                ...
                await _context.SaveChangesAsync();
                new ImageClass().RemoveSVG(group.Img);
            }
