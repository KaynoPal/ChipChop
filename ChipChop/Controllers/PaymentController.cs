...
public class PaymentController : Controller
{
    ...
    private static readonly string mainUrl = "https://localhost:44327/";
    ...
    public async Task<IActionResult> RequestPaymentGate(int id)//factorId
    {
        ...
        ZarinpalRespose zarinpalResponse =
            JsonConvert.DeserializeObject<ZarinpalRespose>(response);
    ...
    public async Task<IActionResult> VerifyPaymentGate(int factorId, string status, string authority)
    {
        ...
        return RedirectToAction("PaymentResult", new { factorId = factorId });
    }
